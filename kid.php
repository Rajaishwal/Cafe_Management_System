...
<div class="container mt-5">
  ...
  <div class="card" style="width: 18rem;">
      ...
      <div class="card" style="width: 18rem;">
          <img src="./drink3.jpg" class="card-img-top" alt="...">
          <div class="card-body">
              <h5 class="card-title">Diet Coke</h5>
              <p class="card-text"><span class="rating">★★★★☆</span><br>
              <span>Price: <h5>₹80.00</h5></span></p>
              <a href="" class="btn" name="add_to_cart" style="background-color: #3e2723; color: white; border: none;">
              Add Item </a>
      ...
      <div class="card" style="width: 18rem;">
          <img src="./drink.webp" class="card-img-top" alt="...">
          <div class="card-body">
              <h5 class="card-title">Venilla Milkshake</h5>
              <p class="card-text"><span class="rating">★★★★☆</span><br>

...
<div class="container mt-5">
  ...
  <div class="card" style="width: 18rem;">
          ...
          <div class="card-body">
              ...
              <span>Price:<h5>₹150.00</h5></span></p>
              <a href="" class="btn" name="add_to_cart" style="background-color: #3e2723; color: white; border: none;">
              Add Item </a>
          </div>
      </div>
      <div class="card" style="width: 18rem;">
          <img src="./fries.webp" class="card-img-top" alt="...">
          <div class="card-body">
              <h5 class="card-title">French Fries</h5>
              <p class="card-text"><span class="rating">★★★★☆</span><br>
              <span>Price:<h5>₹110.00</h5></span></p>
              <a href="" class="btn" name="add_to_cart" style="background-color: #3e2723; color: white; border: none;">
              Add Item </a>
          </div>
      </div>
      <div class="card" style="width: 18rem;">
          <img src="./nacho.webp" class="card-img-top" alt="...">
          <div class="card-body">
              <h5 class="card-title">Nachos Maxicanos</h5>
              <p class="card-text"><span class="rating">★★★★☆</span><br>
      ...
      <div class="card" style="width: 18rem;">
          ...
          <div class="card-body">
              <h5 class="card-title">Chesse Cake</h5>
              <p class="card-text"><span class="rating">★★★★☆</span><br>
